	...
	private void initialize() {
		...
		btnVieweditSupplies.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				parent.repaint();
				parent.revalidate();
//				supply.getModel().addTableModelListener(new TableModelListener()
//				{
//					public void tableChanged(TableModelEvent e) {
//						int selectedRowIndex;
//						selectedRowIndex = supply.getSelectedRow();
//						menu_val[index][0] = supply.getValueAt(selectedRowIndex, 0).toString();
//						menu_val[index][1] = supply.getValueAt(selectedRowIndex, 2).toString();
//						index++;
//					}
//				});
			}
	...
	public void updateValues() {
		...
		supply.setModel(refresh_supply());
//		supply.getModel().addTableModelListener(
